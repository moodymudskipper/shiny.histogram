...
The minimal app is taken straight from Hadley Wickham's "Mastering Shiny" with minor modifications.
...
Though you might be better off cloning the repo or reproducing from code below 
...
* ui is a function! In case your ui is an object, a "fluidPage" for instance, just
 wrap it into an argumentless function as I did above.
...
* The functions need to be in a package, if you're working on this package
  you might use `devtools::load_all()` but don't source or define functions
  manually (e.g. through the "run" button in Rstudio, or with Ctrl/Command + Enter)
  as it will place these functions in the global environment and we want them
